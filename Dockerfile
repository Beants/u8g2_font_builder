...
RUN wget https://github.com/adobe-fonts/source-han-serif/raw/release/Variable/TTF/SourceHanSerifSC-VF.ttf SourceHanSerifSC_VF.ttf
...
COPY static static
RUN ls -l
RUN mv SourceHanSerifSC_VF.ttf static/font/
CMD python3 app.py
